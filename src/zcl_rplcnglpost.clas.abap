...
*        DATA lt_target LIKE <ls_line>-%target.
    ...
    FIELDS comp_code, imfyear, imno, imdate, implant, location, imcramt, imdealercode
    WHERE glposted = ''
    ...
    LOOP AT ltcrdata ASSIGNING FIELD-SYMBOL(<ls_crdata>).
        ...
        IF ltPlant IS NOT INITIAL.
            ...
            accountingdocumentheadertext = <ls_crdata>-imno && `- GL Dealer CN`
        ...
        ELSE.
            ...
            IF lt_commit_failed is INITIAL.
               data: jeno type char72.
                ...
                jeno = <ls_crdata>-imno && `- GL Dealer CN`.
