...
define view entity ZR_INVOICEDATATAB1
  as select from zinvoicedatatab1
association to parent ZR_INV_MST as _Header on $projection.CompCode = _Header.CompCode and $projection.Plant = _Header.Plant 
                        and $projection.Idfyear = _Header.Imfyear and $projection.Idtype = _Header.Imtype and $projection.Idno = _Header.Imno
{
